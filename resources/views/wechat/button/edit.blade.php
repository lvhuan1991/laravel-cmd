                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" v-model="currentMenu.type"
                                                         value="view"  type="radio">
                                                        <label class="form-check-label" for="inlineRadio1">链接</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" v-model="currentMenu.type"
                                                               value="click" name="inlineRadioOptions" id="inlineRadio2">
                                                ...
                                                <div class="form-group" v-if="currentMenu.type == 'view'">
                                                    ...
                                                    <input type="text" v-model="currentMenu.url" class="form-control"
                                                           id="exampleInputEmail1" placeholder="">
                                                </div>
                                                <div class="form-group" v-if="currentMenu.type == 'click'">
                                                    <label for="exampleInputEmail1">关键词</label>
                                                    <input type="text" v-model="currentMenu.key" class="form-control"
                                                           id="exampleInputEmail1" placeholder="">
                                                </div>
